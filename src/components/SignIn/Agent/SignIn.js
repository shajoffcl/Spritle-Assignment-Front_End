...
import {agentDoLogin, agentIsLogin} from "../../../services/authService"
...
export default function SignIn(props) {
  ...
  if(agentIsLogin()){
    props.history.push("/agent/dashboard");
  }
  ...
  const handleLogin = () => {
    ...
    Axios.post("http://localhost:8080/agent/access",{
      username:account.username,
      password:account.password
    }).then((res)=>{
      agentDoLogin(res.data._id);
      props.history.push("/agent/dashboard")
    },
    ()=>setOpen(true))
  };
